#ifndef CONNECTX_PERCEPTION_CPP__OPTICAL_FLOW_NODE_HPP_
#define CONNECTX_PERCEPTION_CPP__OPTICAL_FLOW_NODE_HPP_
...
#endif  // CONNECTX_PERCEPTION_CPP__OPTICAL_FLOW_NODE_HPP_
